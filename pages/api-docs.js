  ...
  return (
    <div className="container">
      <div className="jumbotron">
        ...
        <h3>
          <a href="/api/shootings">/api/shootings</a> will return all records in
          our DB
        </h3>
        ...
        <h3>
          /api/count/shootings/state/name will return the count of all shootings
          records by state
        </h3>
        <h3>
          /api/count/shootings/state/abbv will return the count of all shootings
          records by state abbreviation
        </h3>
        <h3>
        ...
        <h3>
          /api/count/brutality/state/name will return the count of all brutality
          records by state
        </h3>
        <h3>
          /api/count/brutality/state/abbv will return the count of all brutality
          records by state abbreviation
        </h3>
        <h3>
