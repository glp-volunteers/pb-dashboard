...
const mockData = [
  { name: "California", value: 1186 },
  { name: "Texas", value: 719 },
  { name: "Florida", value: 540 },
  { name: "Arizona", value: 343 },
  { name: "Georgia", value: 265 },
  { name: "Colorado", value: 227 },
  { name: "Washington", value: 218 },
  { name: "Ohio", value: 215 },
  { name: "Oklahoma", value: 214 },
  { name: "North Carolina", value: 204 },
  { name: "Montana", value: 197 },
  { name: "Illinois", value: 181 },
  { name: "Tennessee", value: 179 },
  { name: "Pennsylvania", value: 171 },
  { name: "New York", value: 155 },
  { name: "Louisiana", value: 148 },
  { name: "New Mexico", value: 142 },
  { name: "Alabama", value: 138 },
  { name: "Maryland", value: 128 },
  { name: "Virginia", value: 124 },
  { name: "Indiana", value: 124 },
  { name: "Michigan", value: 123 },
  { name: "Kentucky", value: 122 },
  { name: "Nevada", value: 121 },
  { name: "South Carolina", value: 120 },
  { name: "Oregon", value: 113 },
  { name: "Wisconsin", value: 111 },
  { name: "Mississippi", value: 108 },
  { name: "Arizona", value: 103 },
  { name: "New Jersey", value: 103 },
  { name: "Montana", value: 84 },
  { name: "Utah", value: 82 },
  { name: "Kansas", value: 75 },
  { name: "West Virginia", value: 74 },
  { name: "Massachusetts", value: 56 },
  { name: "Idaho", value: 48 },
  { name: "Indiana", value: 45 },
  { name: "Alaska", value: 41 },
  { name: "Minnesota", value: 40 },
  { name: "Hawaii", value: 37 },
  { name: "Nebraska", value: 36 },
  { name: "Connecticut", value: 36 },
  { name: "Maine", value: 31 },
  { name: "District of Columbia", value: 26 },
...
const cityDate = [
  { count: 2000, city: "New York City", lat: 40.71455, lon: -74.007124 },
  { count: 64000, city: "San Francisco", lat: 37.7771187, lon: -122.4196396 },
  { count: 800, city: "Santa Cruz", lat: 36.9740181, lon: -122.0309525 },
  { count: 300, city: "Santa Barbara", lat: 34.4193802, lon: -119.6990509 },
  { count: 1000, city: "Tucson", lat: 32.22155, lon: -110.9697571 },
  { count: 14000, city: "Washington DC", lat: 38.8903694, lon: -77.0319595 },
];
...
function BubbleHeatmap() {
  ...
  useEffect(() => {
    ...
    var legendText = ["Most Cases", "No Cases"];
    ...
    color.domain([0, 14126]); // setting the range of the input data
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      for (var j = 0; j < 51; j++) {
        ...
        if (dataState == jsonState) {
          ...
          usStates.features[j].properties.count = dataValue;
          console.log(dataValue);
  ...
  return (
    <div>
      <h2>Police Brutality Heatmap</h2>
      <svg id="heatmap" ref={ref} />
    </div>
  );
}
